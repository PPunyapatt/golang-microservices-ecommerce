...
func StartgRPCServer(ctx context.Context, orderServiceRPC order.OrderServiceServer, wg *sync.WaitGroup, pm *metrics.Metrics) {
	s := grpc.NewServer(
	...
	slog.Info("🚀 gRPC server started on :1028")
	go func() {
