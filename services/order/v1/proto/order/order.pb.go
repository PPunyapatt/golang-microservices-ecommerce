...
const file_order_proto_rawDesc = "" +
	...
	"\aOrderID\x18\x03 \x01(\x05R\aOrderID2\xa0\x02\n" +
	"\fOrderService\x12A\n" +
...
var file_order_proto_goTypes = []any{
	...
	(*OrderItems)(nil),          // 3: order.v1.OrderItems
	(*Orders)(nil),              // 4: order.v1.Orders
	(*StoreOrderItems)(nil),     // 5: order.v1.StoreOrderItems
	...
	(*ListOrderResponse)(nil),   // 9: order.v1.ListOrderResponse
	(*PlaceOrderRequest)(nil),   // 10: order.v1.PlaceOrderRequest
	(*PlaceOrderResponse)(nil),  // 11: order.v1.PlaceOrderResponse
	(*UpdateStatusRequest)(nil), // 12: order.v1.UpdateStatusRequest
}
var file_order_proto_depIdxs = []int32{
	2,  // 0: order.v1.OrderItems.items:type_name -> order.v1.item
	5,  // 1: order.v1.Orders.items:type_name -> order.v1.StoreOrderItems
	3,  // 2: order.v1.GetOrderResponse.order_items:type_name -> order.v1.OrderItems
	4,  // 3: order.v1.ListOrderResponse.orders:type_name -> order.v1.Orders
	1,  // 4: order.v1.ListOrderResponse.pagination:type_name -> order.v1.Pagination
	3,  // 5: order.v1.PlaceOrderRequest.order_items:type_name -> order.v1.OrderItems
	6,  // 6: order.v1.OrderService.GetOrder:input_type -> order.v1.GetOrderRequest
	8,  // 7: order.v1.OrderService.ListOrder:input_type -> order.v1.ListOrderRequest
	10, // 8: order.v1.OrderService.PlaceOrder:input_type -> order.v1.PlaceOrderRequest
	12, // 9: order.v1.OrderService.UpdateStatus:input_type -> order.v1.UpdateStatusRequest
	7,  // 10: order.v1.OrderService.GetOrder:output_type -> order.v1.GetOrderResponse
	9,  // 11: order.v1.OrderService.ListOrder:output_type -> order.v1.ListOrderResponse
	11, // 12: order.v1.OrderService.PlaceOrder:output_type -> order.v1.PlaceOrderResponse
	0,  // 13: order.v1.OrderService.UpdateStatus:output_type -> order.v1.Empty
